...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  void _verifyPhoneNumber(String phoneNumber) async {
    ...
    final PhoneCodeSent codeSent =
      ...
      Navigator.pushReplacementNamed(context, verificationCodeRoute, arguments: {
        'isLogin': false,
                ...
                child: SingleChildScrollView(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Text(AppLocalizations.of(context).tr('full_name'),
                          style: TextStyle(
                            fontFamily: 'Roboto',
                    ...
                    TextFormField(
                        ...
                        decoration: InputDecoration(
                          hintText:
                              AppLocalizations.of(context).tr('name_example'),
                        ),
                        style: TextStyle(
                          fontFamily: 'Roboto',
                          fontSize: ScreenUtil.instance.setSp(12.0),
                    ...
                    TextFormField(
                        ...
                        decoration: InputDecoration(
                          hintText:
                              AppLocalizations.of(context).tr('email_example'),
                        ),
                        style: TextStyle(
                          fontFamily: 'Roboto',
                          fontSize: ScreenUtil.instance.setSp(12.0),
                    ...
                    Container(
                      ...
                      child:
                          Text(AppLocalizations.of(context).tr('phone_number'),
                              style: TextStyle(
                                fontFamily: 'Roboto',
                                fontSize: ScreenUtil.instance.setSp(12.0),
                              )),
