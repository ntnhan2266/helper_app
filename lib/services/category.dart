...
class CategoryService {
  static const String _getAvailableCategoriesRoute = APIConfig.baseURL + '/categories/available';
  ...
  static Future<Map<String, dynamic>> getAvailableCategories() async {
    ...
    var response = await http.get(_getAvailableCategoriesRoute, headers: headers);
